                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {mode === "signup" && (
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input id="name" placeholder="Your name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} className="pl-9 glass" />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <Input id="email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-9 glass" autoFocus />
                    </div>
                  </div>
                  ...
                  {mode !== "forgot" && (
                    <>
                      ...
                      <Button type="button" variant="outline" className="w-full h-11 glass font-medium" onClick={handleGoogle}>
